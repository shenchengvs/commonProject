...
public class ListUtil {
    ...
    public static String intListToStr(List<Integer> list, String sep) {
        StringBuilder sb = new StringBuilder();
        if (list != null) {
    ...
    public static List mapToList(Map<String, ?> map) {
     ...
     * @param list
     */
    public static List<Integer> sortIntListAsc(List<Integer> list) {
