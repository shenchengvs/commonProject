...
public class NumberUtil extends NumberUtils {
    ...
    public static int SCALE_1       = 1;                       // 精确1位小数位
    public static int SCALE_2       = 2;                       // 精确2位小数位
    public static int SCALE_3       = 3;                       // 精确3位小数位
    public static int SCALE_4       = 4;                       // 精确4位小数位

    public static int PERCISION     = BigDecimal.ROUND_DOWN;   // 截取
    public static int ROUND_HALF_UP = BigDecimal.ROUND_HALF_UP;// 四舍五入
    ...
    public static BigDecimal get4Out5In(String b) {
        return new BigDecimal(b).setScale(DEF_SCALE, PERCISION);
    }
    ...
    // BigDecimal转String，小数点截取处理
    public static String formateScaleStr(BigDecimal value, int scale) {
        if (value == null) return "";
        return value.setScale(scale, PERCISION).toString();
    }
    ...
    public static String formateScale3Str(BigDecimal value) {
        if (value == null) return "";
        return value.setScale(SCALE_3, PERCISION).toString();
    }

    public static String formateScale4Str(BigDecimal value) {
        if (value == null) return "";
        return value.setScale(SCALE_4, PERCISION).toString();
    }

    // BigDecimal转String，小数点截取四舍五入处理
    /**
     * 四舍五入
     * 
     * @param value
     * @return
     */
    public static String formateScaleHalfUp2Str(BigDecimal value) {
        if (value == null) return "";
        return value.setScale(DEF_SCALE, ROUND_HALF_UP).toString();
    }

    public static String formateScaleHalfUp3Str(BigDecimal value) {
        if (value == null) return "";
        return value.setScale(SCALE_3, ROUND_HALF_UP).toString();
    }
     ...
     * @return
     */
    public static String num2PadString(Integer value, int radix, int length, String pad) {
        if (value == null) return StringUtil.charPad("0", length, pad);
        String result = Integer.toString(value, radix);
        return StringUtil.AddjustLength(result, length, pad);
    }
