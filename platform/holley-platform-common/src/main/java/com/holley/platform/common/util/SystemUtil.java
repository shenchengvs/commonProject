...
import com.holley.platform.common.i18n.LocaleUtil;

/**
 * 取得有关系统信息的工具类。
 * <p>
 * 如果因为Java安全的原因而不能取得System.getProperty，则相应的字段将被设置成null， 并且这个消息将被输出到System.err中。
 * </p>
 */
public class SystemUtil {
    ...
    public static final class JavaInfo {
         ...
         * 判断当前Java的版本。
         * <p>
         * 如果不能取得系统属性java.version（因为Java安全限制），则总是返回false
         * </p>
         * 
         ...
         * </p>
         * <ul>
         * <li>测试JDK 1.2：isJavaVersionAtLeast(1.2f)</li>
         * <li>测试JDK 1.2.1：isJavaVersionAtLeast(1.31f)</li>
         * </ul>
         * 
         ...
         * </p>
         * <ul>
         * <li>测试JDK 1.2：isJavaVersionAtLeast(120)</li>
         * <li>测试JDK 1.2.1：isJavaVersionAtLeast(131)</li>
         * </ul>
         * 
         * @param requiredVersion 需要的版本
         * @return 如果当前Java版本大于或等于指定的版本，则返回true
    ...
    public static final class OsInfo {
         ...
         * <p>
         * 这个编码字符集将被作为当前JVM转换字节/字符的默认方式。 例如：GBK。
         * </p>
         * 
         * @return 属性值，如果不能取得（因为Java安全限制）或值不存在，则返回null。
         * @since Java 1.2
    ...
    public static final class UserInfo {
        ...
        private final String USER_COUNTRY   = ((getSystemProperty("user.country", false) == null) ? getSystemProperty("user.region", false) : getSystemProperty("user.country",
                                                                                                                                                                false));
    ...
    /**
     * 取得系统属性，如果因为Java安全的限制而失败，则将错误打在System.err中，然后返回null。
     * 
     * @param name 属性名
     * @param quiet 安静模式，不将出错信息打在System.err中
     * @return 属性值或null
     */
    ...
    public static void main(String[] args) {
        ...
        List<String> list = new ArrayList(System.getProperties().keySet());
