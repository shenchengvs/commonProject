...
public class SMS4 {
    ...
    private static byte[] decode16(byte[] ciphertext, byte[] key) {
	 ...
	 public static void main(String[] args) {
	        ...
	        String key1 = "@$DcS*&DB09^%12!";
	        String key2 = "dongong";
	        String data = "18969030631";
	        byte keybyte[]= {64,36,68,99,83,42,38,68,66,48,57,94,37,49,50,33};
	        ...
	        byte de[] = SMS4.encodeSMS4(data, keybyte);

	        //System.out.println(de);
	        System.out.println(SMS4.decodeSMS4toString(de, keybyte));
	    }
}
