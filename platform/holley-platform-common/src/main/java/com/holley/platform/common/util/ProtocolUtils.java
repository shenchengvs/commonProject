...
public class ProtocolUtils {
    ...
    public static int byteToInteger(byte[] data, int from) {
        ...
        return (int) (ProtocolUtils.Unsignd(data[from + 3]) * 0x1000000 + ProtocolUtils.Unsignd(data[from + 2]) * 0x10000 + ProtocolUtils.Unsignd(data[from + 1]) * 0x100
    ...
    public static long byteTolong(byte[] data, int from) {
        ...
        return (long) (ProtocolUtils.Unsigndlong(data[from + 3]) * 0x1000000 + ProtocolUtils.Unsignd(data[from + 2]) * 0x10000 + ProtocolUtils.Unsignd(data[from + 1]) * 0x100
                       + ProtocolUtils.Unsignd(data[from]));
    }
