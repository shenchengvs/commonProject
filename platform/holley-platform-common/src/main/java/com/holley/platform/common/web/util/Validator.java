package com.holley.platform.common.web.util;
...
public class Validator {
     ...
     * 正则表达式：验证IP地址
     */
    public static final String REGEX_IP_ADDR   = "([1-9]|[1-9]\\d|1\\d{2}|2[0-4]\\d|25[0-5]|0)(\\.(\\d|[1-9]\\d|1\\d{2}|2[0-4]\\d|25[0-5])){3}";
     ...
     * 正则表达式：功率
     */
    public static final String REGEX_P         = "^(([1-9]{1}\\d*)|([0]{1}))(\\.(\\d){0,4})?$";

    /**
     * 正则表达式：表码
     */
    public static final String REGEX_BM        = "^(([1-9]{1}\\d*)|([0]{1}))(\\.(\\d){0,4})?$";
     ...
     * @return
     */
    public static boolean isPower(String value) {
        if (value == null) return false;
        return Pattern.matches(REGEX_P, value);
    }
     ...
     * @return
     */
    public static boolean isBm(String bm) {
        if (bm == null) return false;
        return Pattern.matches(REGEX_BM, bm);
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Validator.isPower("30"));
    }
}
