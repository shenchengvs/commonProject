package com.holley.platform.common.db;
...
import com.holley.platform.common.util.ReflectHelper;

@Intercepts({ @Signature(type = StatementHandler.class, method = "prepare", args = { Connection.class, Integer.class }) })
public class MybatisPagePluginNew implements Interceptor {
                ...
                if (parameterObject == null) {
                    ...
                    if (parameterObject instanceof Page) { // 参数就是Page实体
                        ...
                        if (obj != null) {
                            ...
                            page = new Page(0, Globals.EXPORT_MAX);
                            // page.setTotalProperty(count);
                        }
        ...
        if (!StringUtils.isEmpty(dialect)) {
            ...
            if ("oracle".equals(dialect)) {
                ...
                if (page != null) {
                    ...
                    pageSql.append(page.getStartRow());
                    pageSql.append(",");
                    pageSql.append(page.getEndRow() - page.getStartRow());
                }
            }
            return pageSql.toString();
        } else {
